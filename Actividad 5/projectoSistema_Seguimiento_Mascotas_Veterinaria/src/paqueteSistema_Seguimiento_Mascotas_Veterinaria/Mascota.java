...
public class Mascota {
    ...
    // NUEVO: para que System.out.println(cl.getPacientes()) se vea amigable
    @Override
    public String toString() {
        return "Mascota{nombre='%s', especie='%s', edad=%d, dueño='%s'}"
                .formatted(nombre, especie, edad, dueño.getNombre());
    }
}
